...
MAP_PROMPT = (
    ...
    "Сохраняй у пунктов таймкоды [MM:SS] из реплик — по ним финальный документ будет "
    "ссылаться на момент записи.\n"
...
FOLD_PROMPT = (
    ...
    "выбрасывай. Таймкоды [MM:SS] у пунктов тоже сохраняй. Но схлопни повторы: "
    "один и тот же пункт, попавший в несколько "
